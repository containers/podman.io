export const LATEST_VERSION = '5.8.3';
export const LATEST_DESKTOP_VERSION = '1.27.2';
export const LATEST_DESKTOP_DOWNLOAD_URL = 'https://podman-desktop.io/blog/podman-desktop-release-1.27';
