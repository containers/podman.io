export const LATEST_VERSION = '6.0.1';
export const LATEST_DESKTOP_VERSION = '1.28.3';
export const LATEST_DESKTOP_DOWNLOAD_URL = 'https://podman-desktop.io/blog/podman-desktop-release-1.28';
