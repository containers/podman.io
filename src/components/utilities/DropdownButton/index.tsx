  ...
  return (
    <div>
      <button
        ...
        className="flex items-center gap-2 rounded-md  bg-white px-4 py-2 font-bold transition duration-150 ease-linear hover:bg-purple-700 hover:text-white focus:shadow-md dark:text-purple-900 dark:hover:text-white">
        <span>{props.buttonText}</span>
        <Icon icon="ion:caret-down-outline" />
      </button>
      {open && (
        <div id="dropdown" className="mt-2 max-w-fit rounded-md bg-white shadow-md dark:bg-gray-900">
