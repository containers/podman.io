---
title: Basic Setup and Use of Podman
version: v5.4.1
---
...
For more information on Podman and its subcommands, checkout the asciiart demos on the [README.md](https://github.com/containers/podman/blob/main/README.md#commands)
page.
