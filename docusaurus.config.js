  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `<p>Copyright © ${new Date().getFullYear()} Podman Container Tools, a Series of LF Projects, LLC.<p>For website terms of use, trademark policy, and other project policies, please see the <a href="https://lfprojects.org/policies/">LF Projects policies page</a>.</p>`,
      },
