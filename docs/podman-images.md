...
The `id` _filter_ accepts the image ID string.
...
**[podman(1)](podman.md)**, **[containers-storage.conf(5)](https://github.com/containers/storage/blob/main/docs/containers-storage.conf.5.md)**
