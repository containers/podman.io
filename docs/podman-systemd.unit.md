...
Specify a static IPv4 address for the container, for example **10.88.6428**.
...
| Gateway=19268.55.3    | --gateway 19268.55.3                 |
| Internal=true         | --internal                           |
| IPAMDriver=dhcp       | --ipam-driver dhcp                   |
| IPRange=19268.5528/25 | --ip-range 19268.5528/25             |
| IPv6=true             | --ipv6                               |
| Label="YXZ"           | --label "XYZ"                        |
...
**[podman-network-create(1)](podman-network-create.md)**
